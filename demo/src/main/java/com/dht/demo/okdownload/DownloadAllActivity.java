...
public class DownloadAllActivity extends BaseActivity implements XExecutor.OnAllTaskEndListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.dht.demo.R.layout.activity_download_all);
    ...
    @OnClick(com.dht.demo.R.id.removeAll)
    ...
    @OnClick(com.dht.demo.R.id.pauseAll)
    public void pauseAll(View view) {
        okDownload.pauseAll();
    }

    @OnClick(com.dht.demo.R.id.startAll)
