...
import com.dht.okserver.OkUpload;
...
public class UploadAllActivity extends BaseActivity implements XExecutor.OnAllTaskEndListener {
    ...
    @Bind(com.dht.demo.R.id.toolbar) Toolbar toolbar;
    @Bind(com.dht.demo.R.id.recyclerView) RecyclerView recyclerView;
    @Bind(com.dht.demo.R.id.select) Button select;
    @Bind(com.dht.demo.R.id.upload) Button upload;
    @Bind(com.dht.demo.R.id.deleteAll) Button deleteAll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.dht.demo.R.layout.activity_upload_list);
    ...
    @OnClick(com.dht.demo.R.id.deleteAll)
