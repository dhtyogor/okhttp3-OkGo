...
public class RxBitmapActivity extends BaseRxDetailActivity {
    ...
    @Bind(com.dht.demo.R.id.imageView) ImageView imageView;

    @Override
    protected void onActivityCreate(Bundle savedInstanceState) {
        setContentView(com.dht.demo.R.layout.activity_bitmap_request);
    ...
    @OnClick(com.dht.demo.R.id.requestImage)
